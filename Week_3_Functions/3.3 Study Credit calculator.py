...
def main ():
    ...
    if zero_credits_in_a_row != 2:
        ...
        if average_credits >= 5.5:
            print(f"You are a full time student and your monthly credit point average is {average_credits:.1f}.")
        else:
            print(f'Your monthly credit point average {average_credits:.1f} does not classify you as a full time student.')
